...
class _UpdateRequiredScreenState extends State<UpdateRequiredScreen> {
  ...
  Future<void> _downloadAndInstallWindows() async {
    ...
    try {
      ...
      await _installer.installInnoSetup(
        installerExe: file,
        installerArgs: null,
      );
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _installing
                        ? null
                        : (widget.state.downloadUrl != null &&
                                widget.state.downloadUrl!.isNotEmpty)
                            ? (Platform.isWindows
                    ...
                    child: Text(
                      _installing ? 'Updating...' : 'Update Now',
