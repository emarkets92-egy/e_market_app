...
class UnlocksResponseModel {
  ...
  UnlocksResponseModel({required this.data, required this.meta});

  factory UnlocksResponseModel.fromJson(Map<String, dynamic> json) {
    return UnlocksResponseModel(
      data: (json['data'] as List<dynamic>?)?.map((e) => UnlockItemModel.fromJson(e as Map<String, dynamic>)).toList() ?? [],
